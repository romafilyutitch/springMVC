...
public abstract class AbstractDao<T extends Entity> implements Dao<T> {
    ...
    private static final String FIND_ALL_SQL_TEMPLATE = "select id, %s from %s limit ?, ?";
    ...
    public List<T> findPage(int offset, int limit) {
        return template.query(findAllSql, rowMapper, offset, limit);
    }
    ...
    public void delete(T entity) {
        template.update(deleteSql, entity.getId());
    }
